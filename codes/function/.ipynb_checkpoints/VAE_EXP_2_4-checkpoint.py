...
class Encoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.conv6 = nn.Conv2d(1024, 4096, kernel_size=3, stride=2, padding=1) # 1
        self.fc_mu = nn.Linear(4096 * 4 * 4, latent_dim) # 1
        self.fc_logvar = nn.Linear(4096 * 4 * 4, latent_dim) # 1
...
class Decoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.fc = nn.Linear(latent_dim, 4096*4*4) # 3
        self.conv6 = nn.ConvTranspose2d(4096, 1024, kernel_size=4, stride=2, padding=1, output_padding=0) #3
